            ...
            <div class="col-lg-12">
                <form id="search-form" method="POST" role="search" action="search.php">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <fieldset>
                                <select name="destinations" class="form-select" aria-label="Default select example"
                            ...
                            <div class="content">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <span class="list"><?= $city->trip_days; ?> Days</span>
                                    </div>
                                    <div class="col-6">
                                        <i class="fa fa-map"></i>
                                ...
                                <p>Limited Price: $<?= $city->price; ?>/person</p>

...
$countries = $conn->query("SELECT countries.id AS id, countries.name AS name, countries.image AS image, countries.continent AS continent, countries.population AS population, 
    ...
    AVG(cities.price) AS avg_price FROM countries JOIN cities ON countries.id = cities.country_id GROUP BY(cities.country_id)");
            ...
            <div id="top-banner-<?= $country->id; ?>" class="banner">
                <div class="banner-inner-wrapper header-text">
                    <div class="main-caption">
                        ...
                        <h1><?= $country->name; ?></h1>
                        <div class="border-button"><a href="<?= ROOT_URL ?>about.php?id=<?= $country->id; ?>">Go
                                There</a></div>
                    </div>
                    <div class="container">
                        <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-sm-6 col-6">
                                            <div class="main-button">
                                                <a href="<?= ROOT_URL ?>about.php?id=<?= $country->id; ?>">Explore
                                                    More</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="item">
                                <div class="row">
                                    <div class="col-lg-4 col-sm-5">
                                        <div class="image">
                                            <img src="<?= COUNTRY_IMG_URL ?><?= $country->image; ?>" alt="">
                                        </div>
                                    </div>
                                    <div class="col-lg-8 col-sm-7">
                                        <div class="right-content">
                                            ...
                                            <ul class="info">
                                                <li><i class="fa fa-user"></i> <?= $country->population; ?> Mil People
                                                </li>
                                                <li><i class="fa fa-globe"></i> <?= $country->territory; ?> km2</li>
                                                <li><i class="fa fa-home"></i> $<?= $country->avg_price; ?></li>
                                            </ul>
                                            <div class="text-button">
                                                <a href="<?= ROOT_URL ?>about.php?id=<?= $country->id; ?>">Need
